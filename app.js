...
const OBSERVANCES = [
  ...
  { month: 1, day: 11, title: "International Day of Women and Girls in Science", type: 'intl', desc: 'Promoting equal access and participation for women and girls in science.' },
  ...
  { month: 1, day: 21, title: "International Mother Language Day", type: 'intl', desc: 'Promoting linguistic and cultural diversity and multilingualism.' },
  ...
  { month: 2, day: 22, title: "World Water Day", type: 'intl', desc: 'Highlighting the importance of freshwater and sustainable water management.' },
  ...
  { month: 5, day: 19, title: "Rizal Birth Anniversary", type: 'intl', desc: 'Commemorating the birth of Philippine national hero José Rizal.' },
  { month: 5, day: 30, title: "Social Media Day", type: 'intl', desc: 'Recognizing social media\'s impact on global communication.' },
  { month: 6, day: 25, title: "National Campus Press Freedom Day", type: 'journalism', desc: 'Promoting and protecting freedom of expression and the campus press in the Philippines.' },
  { month: 7, day: 8, title: "ASEAN Day", type: 'intl', desc: 'Marking the establishment of the Association of Southeast Asian Nations.' },
  { month: 7, day: 12, title: "National / International Youth Day", type: 'intl', desc: 'Bringing youth issues and contributions to public attention.' },
  { month: 7, day: 30, title: "National Press Freedom Day", type: 'journalism', desc: 'Promoting and safeguarding press freedom in the Philippines.' },
  { month: 8, day: 5, title: "Start of National Teachers' Month", type: 'intl', desc: 'Beginning the annual celebration recognizing teachers and their contributions.' },
  ...
  { month: 8, day: 15, title: "International Day of Democracy", type: 'intl', desc: 'Promoting and upholding the principles of democracy.' },
  ...
  { month: 9, day: 10, title: "World Mental Health Day", type: 'intl', desc: 'Raising awareness of mental health issues and mobilizing support for mental well-being.' },
  ...
  { month: 10, day: 17, title: "International Students' Day", type: 'intl', desc: 'Recognizing students and the importance of access to education.' },
  ...
  { month: 10, day: 25, title: "International Day for the Elimination of Violence Against Women", type: 'intl', desc: 'Calling for action to prevent and eliminate violence against women and girls.' },
  { month: 11, day: 3, title: "International Day of Persons with Disabilities", type: 'intl', desc: 'Promoting the rights, dignity, and well-being of persons with disabilities.' },
  { month: 11, day: 9, title: "International Anti-Corruption Day", type: 'intl', desc: 'Raising awareness of corruption and the importance of integrity and accountability.' },
